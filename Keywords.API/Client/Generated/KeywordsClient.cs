...
namespace Keywords.API.Client.Generated
{
    ...
    public partial interface IKeywordClient
    {
        ...
        System.Threading.Tasks.Task<PaginatedKeywordsResponse> GetAllKeywordsByVideoIdAsync(PaginatedKeywordsRequest body);
        ...
        /// <returns>Returns all keywords paginated</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<PaginatedKeywordsResponse> GetAllKeywordsByVideoIdAsync(PaginatedKeywordsRequest body, System.Threading.CancellationToken cancellationToken);
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<Keyword> GetKeywordAsync(System.Guid keywordId);
        ...
        /// <returns>Keyword found</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<Keyword> GetKeywordAsync(System.Guid keywordId, System.Threading.CancellationToken cancellationToken);
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<Keyword> PublishKeywordAsync(System.Guid keywordId, bool? toBePublished);
        ...
        /// <returns>Keyword published</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<Keyword> PublishKeywordAsync(System.Guid keywordId, bool? toBePublished, System.Threading.CancellationToken cancellationToken);

    }

    [System.CodeDom.Compiler.GeneratedCode("NSwag", "14.0.0.0 (NJsonSchema v11.0.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class KeywordClient : IKeywordClient
    {
        private string _baseUrl = "https://keywordsbackend.azurewebsites.net";
        ...
        /// <returns>Returns all keywords paginated</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<PaginatedKeywordsResponse> GetAllKeywordsByVideoIdAsync(PaginatedKeywordsRequest body)
        {
            return GetAllKeywordsByVideoIdAsync(body, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Returns all keywords paginated</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<PaginatedKeywordsResponse> GetAllKeywordsByVideoIdAsync(PaginatedKeywordsRequest body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/keywords/");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<PaginatedKeywordsResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
        ...
        /// <returns>Keyword found</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<Keyword> GetKeywordAsync(System.Guid keywordId)
        {
            return GetKeywordAsync(keywordId, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Keyword found</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<Keyword> GetKeywordAsync(System.Guid keywordId, System.Threading.CancellationToken cancellationToken)
        {
            if (keywordId == null)
                throw new System.ArgumentNullException("keywordId");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/keyword/keywordId/{keywordId}");
            urlBuilder_.Replace("{keywordId}", System.Uri.EscapeDataString(ConvertToString(keywordId, System.Globalization.CultureInfo.InvariantCulture)));
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            string responseText_ = ( response_.Content == null ) ? string.Empty : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new ApiException("Keyword not found", status_, responseText_, headers_, null);
                        }
                        else
                        {
                            var responseData_ = response_.Content == null ? null : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
        ...
        /// <returns>Keyword published</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<Keyword> PublishKeywordAsync(System.Guid keywordId, bool? toBePublished)
        {
            return PublishKeywordAsync(keywordId, toBePublished, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Keyword published</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<Keyword> PublishKeywordAsync(System.Guid keywordId, bool? toBePublished, System.Threading.CancellationToken cancellationToken)
        {
            if (keywordId == null)
                throw new System.ArgumentNullException("keywordId");
            ...
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("toBePublished") + "=").Append(System.Uri.EscapeDataString(ConvertToString(toBePublished, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            }
            urlBuilder_.Length--;
    ...
    [System.CodeDom.Compiler.GeneratedCode("NSwag", "14.0.0.0 (NJsonSchema v11.0.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class IndexerClient : IIndexerClient
    {
        private string _baseUrl = "https://keywordsbackend.azurewebsites.net";
        private static System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings = new System.Lazy<Newtonsoft.Json.JsonSerializerSettings>(CreateSerializerSettings, true);
    ...
    [System.CodeDom.Compiler.GeneratedCode("NSwag", "14.0.0.0 (NJsonSchema v11.0.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class SpeechClient : ISpeechClient
    {
        private string _baseUrl = "https://keywordsbackend.azurewebsites.net";
        private static System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings = new System.Lazy<Newtonsoft.Json.JsonSerializerSettings>(CreateSerializerSettings, true);
        ...
        public virtual async System.Threading.Tasks.Task<PronunciationAssessmentResponseDTO> CreatePronunciationAssessmentAsync(System.IO.Stream body, string language, string referenceText, System.Threading.CancellationToken cancellationToken)
        {
            ...
            if (referenceText == null)
                throw new System.ArgumentNullException("referenceText");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/speech?");
            ...
            urlBuilder_.Append(System.Uri.EscapeDataString("referenceText") + "=").Append(System.Uri.EscapeDataString(ConvertToString(referenceText, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            urlBuilder_.Length--;
    ...
    public partial interface ITextToSpeechClient
    {
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<Keyword> CreateAudioAsync(System.Guid id);
        ...
        /// <returns>Audio was generated successfully</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<Keyword> CreateAudioAsync(System.Guid id, System.Threading.CancellationToken cancellationToken);

    }

    [System.CodeDom.Compiler.GeneratedCode("NSwag", "14.0.0.0 (NJsonSchema v11.0.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class TextToSpeechClient : ITextToSpeechClient
    {
        private string _baseUrl = "https://keywordsbackend.azurewebsites.net";
        private static System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings = new System.Lazy<Newtonsoft.Json.JsonSerializerSettings>(CreateSerializerSettings, true);
        ...
        /// <returns>Audio was generated successfully</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<Keyword> CreateAudioAsync(System.Guid id)
        {
            return CreateAudioAsync(id, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Audio was generated successfully</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<Keyword> CreateAudioAsync(System.Guid id, System.Threading.CancellationToken cancellationToken)
        {
            if (id == null)
                throw new System.ArgumentNullException("id");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/text/audio/{id}?");
